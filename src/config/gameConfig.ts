...
export const CROP_TYPES: Record<string, CropType> = {
  wheat: {
    ...
    difficulty: "Easy",
    description: "Perfect for beginners. Low risk, quick harvest.",
  },
  carrot: {
    id: "carrot",
    name: "Carrot",
  ...
  eggplant: {
    ...
    gracePeriodMax: 8 * 60 * 60 * 1000,
    difficulty: "Hard",
    description: "Purple treasure. High risk, high reward.",
  },
  pumpkin: {
    id: "pumpkin",
    name: "Pumpkin",
    ...
    difficulty: "Hard",
    description: "Giant harvest! The hardest but most rewarding crop.",
  },
};
